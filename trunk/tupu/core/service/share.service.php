...
class ShareService
{
	...
	public function getSameAlbumShares($share_id = 0,$num = 9)
	{
		...
		if(!$aid)
			return;
		$sql = 'select sp.img as img,als.share_id as share_id,sp.is_animate from '.FDB::table('album_share').' as als 
				left join '.FDB::table('share_photo').' as sp on als.share_id = sp.share_id 
