var hostName = "127.0.0.1/zhubao/"; var domain = "http://127.0.0.1/zhubao/"; var tplName = "huaban"; var global="TUPU";document[global]=document[global] || {};(function() {
    var a = {
        hostName: "",
        domain: "",
		tplName: "",
        ...
        addStyle: function() {
            var e, b;
            if (a.isIE6 || a.isIE7) {
                e = "input[type='button'], .imSubmitInputOff{cursor:pointer;border:0;padding:0;background-image: url("+a.domain+"tpl/"+a.tplName+"/images/"+"addcc_ok0.gif);background-repeat:no-repeat ;visibility:visible;width:340px;height:52px;line-height:52px;margin:0 auto;vertical-align:bottom;}";
                b = "input[type='submit'],.imSubmitInput{cursor:pointer;border:0;padding:0;margin:0;background-image: url("+a.domain+"tpl/"+a.tplName+"/images/"+"addcc_ok1.gif) ; background-repeat:no-repeat;visibility:visible;height: 52px;line-height:52px;margin: 0 auto;vertical-align: text-bottom;width: 340px;}"
            } else {
                e = "input[type='button'],.imSubmitInputOff{cursor:pointer;border:0;padding:0;background:url("+a.domain+"tpl/"+a.tplName+"/images/"+"addcc_ok0.gif) no-repeat;visibility:visible;width:340px;height:52px;line-height:52px;margin:0 auto;vertical-align:bottom;}";
                b = "input[type='submit'],.imSubmitInput{cursor:pointer;border:0;padding:0;background: url("+a.domain+"tpl/"+a.tplName+"/images/"+"addcc_ok1.gif) no-repeat ; visibility:visible;height: 52px;line-height:52px;margin: 0 auto;vertical-align: text-bottom;width: 340px;}"
            }
